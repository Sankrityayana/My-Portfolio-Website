// certifications.js - renders certification cards & modal (refactored for readability & idempotence)
(function () {
  'use strict';
  ...
  function updateHeading(filterKey) {
    ...
    const map = {
      ...
      ai: 'AI / ML Certifications',
      python: 'Python Certifications',
      data: 'Data Certifications',
      cloud: 'Cloud Certifications',
      dev: 'Development Certifications'
    };
